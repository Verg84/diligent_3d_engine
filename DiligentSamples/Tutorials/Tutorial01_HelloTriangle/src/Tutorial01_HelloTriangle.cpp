...
void Tutorial01_HelloTriangle::CreatePipelineState()
{
    ...
    RefCntAutoPtr<IShader> vShader;
    {
        ...
        ShaderCI.Source          = vSource;
        m_pDevice->CreateShader(ShaderCI, &vShader);
    }
